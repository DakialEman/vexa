Quiero construir **Vexa**: quiero ver peliculas y series con mi amigo simultaneamente

Ya tengo definido el proyecto. Este es el brief completo:
...
Implementá el punto 1 del orden de trabajo: **Ventana vacia que abre y cierra bien**

Condiciones:
- Stack: Electron + HTML/CSS/JS. No agregues dependencias que no esten en el brief.
- Respetá la estructura de carpetas del punto 4.
- Codigo funcional y completo, sin `TODO` ni funciones vacias.
- Manejá los errores de forma explicita, no con `except: pass`.
- Si algo del brief es ambiguo, elegí una opcion, implementala y decime que asumiste al final.

Cuando termines ese punto, pará y decime que sigue.